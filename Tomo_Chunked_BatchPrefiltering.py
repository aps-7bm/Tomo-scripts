...
"""
Tomography image stack preprocessor service.
Processes HDF5 files from tomography fly scans, performs median filtering on
repeated scans to remove zingers, and averages the frames to improve S/N. If there is only
one repetition of data, zinger removal using TomoPy will be performed. 
    ...
    while True:         
        ...
        if all_data:
            ...
            if image_data.shape[0]==1:
                ...
                print("Only one replicate found!")
...
def fprocess_hdf_stack(hdf_filenames,output_filename):
    ...
    with h5py.File(fname,'r') as fin:
        ...
        filt2 = fout['measurement']['instrument']['filters']['Filter_2_Material'][...].ravel()
